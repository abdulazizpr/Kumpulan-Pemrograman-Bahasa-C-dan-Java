...
int jumlahganjil(int hasil,simpul *root){
	
	if(root != NULL){
			
		if(root->left != NULL){
			hasil =  jumlahganjil(hasil,root->left);
		}
		if(root->right != NULL){
			hasil =  jumlahganjil(hasil,root->right);
		}
...
int jumlahgenap(int hasil,simpul *root){
	
	if(root != NULL){
			
		if(root->left != NULL){
			hasil =  jumlahgenap(hasil,root->left);
		}
		if(root->right != NULL){
			hasil =  jumlahgenap(hasil,root->right);
		}
